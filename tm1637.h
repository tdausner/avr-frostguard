 ...
 * - etc.
 *
 * index in _digit2segments[]
 * - 0x00 - 0x0F	characters 0...9AbCdEF
 * - 0x10 - ...		characters see below
 */
#define _DSP_H		0x10
#define _DSP_i		0x11
#define _DSP_L		0x12
...
#define _DSP_U		0x18
#define _DSP_u		0x19
#define _DSP_MINUS	0x1A
#define _DSP_ULINE	0x1B
#define _DSP_BLANK	0x1C
...
/**
 * Display message having TM1637_POSITION_MAX letters
 */
void TM1637_display_msg(const uint8_t *msg);
